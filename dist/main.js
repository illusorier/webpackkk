...
// ES6 Supported
var version = 'ES6';
var str = version + ' supported!';

console.log(str);

// JQuery Supported
console.log((0, _jquery2.default)('body').css("background-color"));
...
var instance = _axios2.default.create({ baseURL: 'http://localhost:3000' });
...
var EventLoop = function () {
    ...
    _createClass(EventLoop, [{
        key: 'inQueue',
        value: function inQueue(cb) {
            this.queue.push({ callback: cb });
        }
    }, {
        key: 'outQueue',
        value: function outQueue() {
